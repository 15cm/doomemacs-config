;;; my-org-blog.el --- Provide simple functions to organize my org

;;; my-org-blog.el --- Provide simple functions and configurations for my org notes -*- lexical-binding: t -*-
...
(defun my-org-blog--process-org-input (data-rel-dir keyword-list-to-delete)
...
(defun my-org-blog--convert-to-md (buf)
...
;;;###autoload
(defun my-kill-buffer-and-its-windows (buffer &optional msgp)
...
;;;###autoload
(defun my-org-blog-post-buffer (&optional skip-modify-updated-at)
  ...
  (let* (
    ...
    (let ((original-buffer (current-buffer))
      ...
      (with-temp-buffer
        ...
        (my-org-blog--process-org-input data-rel-dir keyword-list)
        (my-org-blog--convert-to-md md-buffer))
      (with-current-buffer md-buffer
        (my-org-blog--process-md-output title published_at updated_at tags)
        (write-file md-output-file-path))
      (my-kill-buffer-and-its-windows md-buffer))))

(provide 'my-org-blog)
;;; my-org-blog.el ends here
